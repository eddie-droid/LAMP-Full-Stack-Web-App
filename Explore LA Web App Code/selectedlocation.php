...
while($row = $result->fetch_array()){
  ...
  $ThingsToDo = $row["Things To Do"];
  $Tips = $row["Insider Tips"];
...
echo'<div class="slide-3 w-slide">
                <a href="#" class="lightbox-link-2 w-inline-block w-lightbox"><img sizes="(max-width: 479px) 330.59375px, 638.65625px" src="https://maps.googleapis.com/maps/api/place/photo?maxwidth=600&photoreference='.$PhotoID.'&key=AIzaSyCWupLokFzSpQxB6rEj5HJ_OkJXIFhfWV4" loading="eager"  alt="" class="image-26 search-result">
          ...
          <div class="div-block-25">
            ...
            <div class="div-block-29 _50p">
              <div class="div-block-38">
                ...
                <p class="paragraph-6">'.$ThingsToDo.'</p>
              ...
              <div data-w-tab="Tab 1" class="tab-content-item w-tab-pane w--tab-active">
                ...
                <div class="div-block-29">
                  ...
                  foreach ($TipsArray as $Tip){
                      echo'<li class="list-item insidertips">'.$Tip.'</li>';
                  }
...
echo' <a href="#" class="lightbox-link-3 w-inline-block w-lightbox"><img sizes="(max-width: 479px) 83vw, 300.3203125px" loading="lazy" src="https://maps.googleapis.com/maps/api/place/photo?maxwidth=600&photoreference='.$PhotoID.'&key=AIzaSyCWupLokFzSpQxB6rEj5HJ_OkJXIFhfWV4" alt="" class="image-28">
                      <script type="application/json" class="w-json">{
  "items": [
    {
      "_id": "example_img",
...
autoRotate();
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCWupLokFzSpQxB6rEj5HJ_OkJXIFhfWV4&libraries=places&callback=initMap&v=weekly" defer >
   </script>
  <script src="js/webflow.js" type="text/javascript"></script>
