...
@keyframes AnimateBG {
  ...
  <div class="hero wf-section">
    <div data-w-id="938fc91d-e92c-4a9d-8f26-7901f3837188" style="opacity:100%;" class="div-block-2">
      <div class="div-block-53">
        <div class="form-block-3 w-form">
          <form id="email-form-2" name="email-form-2" data-name="Email Form 2" method="get" class="form-4">
            <div class="div-block-54">
              <div class="w-layout-grid grid-14"><input type="text" class="text-field-6 w-node-b4e67db0-3a81-bfa9-7d2e-a79f281f8786-a95db2a1 w-input" maxlength="256" name="field" data-name="Field" placeholder="Search our locations here" id="field" required=""><input type="submit" value="Search" data-wait="Please wait..." id="w-node-_90db5e56-669e-fcdf-48ef-c0906e54d564-a95db2a1" class="submit-button-10 w-button"></div>
    ...
    <div class="second-example-with-unterline-2">
      <div data-current="Tab 1" data-easing="ease-in-out" data-duration-in="300" data-duration-out="300" class="tabs-2 w-tabs">
        <div data-w-id="6a9ea167-c498-0be7-78a9-e863bef28c0f" style="opacity:100%;z-index:9999;" class="tabs-menu-underline-wrapper-2 w-tab-menu">
...
$searchquery = $_GET['SearchQueryString'];
...
$query2 = "";
foreach($searchqueryArray AS $single_word){
  //echo $single_word, " ";
  
  $query2 .= "`Name` LIKE '%".$single_word."%' OR `Summary` LIKE '%".$single_word."%' OR `Categories` LIKE '%".$single_word."%' OR " ;
}
...
$sql = "SELECT * FROM `Locations` WHERE ($query2)";


//old working sql query
